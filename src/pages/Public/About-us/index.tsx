    ...
    <div className="min-h-screen text-white py-8 px-4 font-sans">
      ...
      <div className="mb-16">
        <div className="relative w-full max-w-5xl mx-auto">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[65%] sm:w-[60%] md:w-[70%] lg:w-[75%] h-[65%] sm:h-[70%] md:h-[80%] lg:h-[85%]">
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4 items-stretch h-full">
              ...
              <div className="text-gray-800 h-full overflow-y-auto pr-1 md:pt-8">
                {/* Font size responsive - nhỏ cho mobile, lớn cho desktop */}
                <h2 className="text-center text-[9px] sm:text-xs md:text-lg lg:text-xl font-bold text-[#ddac40] mb-1 md:mb-3 lg:mb-4 drop-shadow-sm">
                  ĐẠI VIỆT KỲ NHÂN
                </h2>
                <div className="space-y-1 md:space-y-2 lg:space-y-3">
                  {/* Font size responsive - tận dụng không gian desktop */}
                  <p className="text-[8px] sm:text-[10px] md:text-sm lg:text-base leading-tight md:leading-relaxed lg:leading-relaxed text-gray-700">
