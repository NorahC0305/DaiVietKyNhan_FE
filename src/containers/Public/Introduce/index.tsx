...
const SuKienTuongTac = ({ onClose }: { onClose: () => void }) => {
    return (
...
const TraiNghiemWebsite = ({ onClose }: { onClose: () => void }) => {
    return (
        <div className="mt-10 w-full flex items-center">
            <div className="bg-[#a4a89d29] border border-[#000000] lg:w-[93%] w-[98%] h-full rounded-xl py-7">
                {/* Title */}
...
const ChuoiHoatDongSanThuong = ({ onClose, onOpenKyAnDocBao }: { onClose: () => void; onOpenKyAnDocBao: () => void }) => {
    return (
        <div className="mt-10 w-full flex items-center">
            <div className="bg-[#a4a89d29] border border-[#000000] lg:w-[93%] w-[98%] h-full rounded-xl py-7">
                {/* Title */}
...
const KyAnDocBan = ({ onClose, onBack }: { onClose: () => void; onBack: () => void }) => {
    return (
        <div className="mt-10 w-full flex items-center">
            <div className="bg-[#a4a89d29] border border-[#000000] lg:w-[93%] w-[98%] h-full rounded-xl py-7">
...
const IntroducePageClient = () => {
    ...
    const handleOpenKyAnDocBao = () => {
        setSelectedActivity('ky-an-doc-bao');
    }

    const handleBackToSanThuong = () => {
        setSelectedActivity('san-thuong');
    }
            ...
            <div className="relative bg-primary-light border-4 border-secondary rounded-2xl w-full lg:max-w-5xl max-w-3xl min-h-screen lg:min-h-[90vh] mx-auto lg:my-8 p-6 pt-3 lg:p-6 max-h-[90vh]">
                <div className="max-h-[87vh] lg:max-h-[83vh] overflow-y-auto ancient-scrollbar">
                    <div className="p-4">
                        ...
                        {selectedActivity === 'trai-nghiem' && <TraiNghiemWebsite onClose={onClose} />}
                        {selectedActivity === 'san-thuong' && <ChuoiHoatDongSanThuong onClose={onClose} onOpenKyAnDocBao={handleOpenKyAnDocBao} />}
                        {selectedActivity === 'su-kien' && <SuKienTuongTac onClose={onClose} />}
                        {selectedActivity === 'ky-an-doc-bao' && <KyAnDocBan onClose={onClose} onBack={handleBackToSanThuong} />}
